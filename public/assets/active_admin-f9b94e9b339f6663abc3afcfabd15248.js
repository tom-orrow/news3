...
(function() {
  $(document).ready(function() {
    $('#show_reject_modal').click(function() {
      return $('div#reject_msg_modal').removeClass('hidden');
    });
    return $('#hide_reject_modal').click(function() {
      $('div#reject_msg_modal #reason').val('');
      return $('div#reject_msg_modal').addClass('hidden');
    });
  });
